...
<body>
<a href="#edit-contacts" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-contacts" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: contactsInstance, action: 'update']" method="PUT">
        <g:hiddenField name="version" value="${contactsInstance?.version}"/>
        <fieldset class="form">
