                        ...
                        <div class="row mtl">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="text-center mbl"><img src="http://lorempixel.com/640/480/business/1/"
                                                                      alt="" class="img-responsive"/></div>

                                    <div class="text-center mbl"><a href="Extras.html#" class="btn btn-green"><i
                            ...
                            <div class="col-md-9">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="Extras.html#tab-edit" data-toggle="tab">Edit Profile</a>
                                    </li>
                                    <li><a href="Extras.html#tab-messages" data-toggle="tab">Messages</a></li>
                                </ul>

                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="Extras.html#" class="form-horizontal"><h3>Account Setting</h3>
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="last name"
                                                                                     class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Gender</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9">
                                                            <div class="radio"><label class="radio-inline"><input
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-4"><input id="datepicker-normal" type="text"
                                                                                     class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label
                                                    class="col-sm-3 control-label">Marital Status</label>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">About</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><textarea rows="3"
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="website"
                                                                                     class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="facebook"
                                                                                     class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="twitter"
                                                                                     class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="tab-messages" class="tab-pane fade in">
                                        <div class="row mbl">
                                            <div class="col-lg-6"><span style="margin-left: 15px"></span><input
                                                    type="checkbox"/><a href="Extras.html#"
                                                                        class="btn btn-success btn-sm mlm mrm"><i
                                                        class="fa fa-send-o"></i>&nbsp;
                                                Write Mail</a><a href="Extras.html#" class="btn btn-white btn-sm"><i
                                        ...
                                        <div class="list-group"><a href="Extras.html#" class="list-group-item"><input
                                                type="checkbox"/><span
                                                class="fa fa-star text-yellow mrm mlm"></span><span
                                                style="min-width: 120px; display: inline-block;"
                                                class="name">Bhaumik Patel</span><span>Sed ut perspiciatis unde</span>&nbsp; - &nbsp;<span
                                                ...
                                                href="Extras.html#" class="list-group-item"><input
                                            ...
                                            - &nbsp;<span style="font-size: 11px;"
                                                          class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt</span><span
                                                    class="badge">12:10 AM</span><span class="pull-right mrl"><span
                                                    class="glyphicon glyphicon-paperclip"></span></span></a><a
                                                href="Extras.html#" class="list-group-item"><input
                                                    type="checkbox"/><span
                                                    ...
                                                    class="name">Bhaumik Patel</span><span>Sed ut perspiciatis unde</span>&nbsp; - &nbsp;<span
                                                    style="font-size: 11px;"
                                                    class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</span><span
                                                    class="badge">12:10 AM</span><span class="pull-right mrl"><span
                                                    class="glyphicon glyphicon-paperclip"></span></span></a><a
                                                href="Extras.html#" class="list-group-item"><input
                                                    type="checkbox"/><span class="fa fa-star-o mrm mlm"></span><span
