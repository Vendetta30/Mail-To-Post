<div class="row setup-content step hiddenStepInfo" id="step-4">
    <div class="col-xs-12">
        <div class="col-md-12 well text-center">
            <h3 class="underline">Enter Your Company Details</h3>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="${companyDetailCO?.companyName}"
                               id="companyName"
                ...
                <div class="form-group">
                    <label for="noOfEmp" class="col-sm-2 control-label">Number of Employee</label>

                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="noOfEmp"
                               value="${companyDetailCO?.noOfEmployee}"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-default"
                                onclick="javascript: resetActive($('#last'), 100, 'step-5');">Next</button>
                    </div>
                </div>
            </div>
