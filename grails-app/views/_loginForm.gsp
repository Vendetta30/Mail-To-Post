...
<div class="modal fade" id="login-overlay" tabindex="-1" role="dialog" aria-labelledby="Modal-label-3">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card card-container">
                    ...
                    <form class="form-signin" role="form" action="${request.contextPath}/j_spring_security_check"
                          method='POST' id='ajaxLoginForm' name='ajaxLoginForm' novalidate="novalidate">
                        <span id="reauth-email" class="reauth-email"></span>
                        <input type="email" id="j_username" class="form-control" placeholder="Email address"
                        ...
                        <button class="btn btn-lg btn-primary btn-block btn-signin" type="button"
                                onclick="loginByAjax()">Sign in</button>
                    </form>
