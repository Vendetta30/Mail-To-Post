...
<body>
<a href="#create-addressBook" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-addressBook" class="content scaffold-create" role="main">
    ...
    <g:form url="[resource: addressBookInstance, action: 'save']">
        <fieldset class="form">
