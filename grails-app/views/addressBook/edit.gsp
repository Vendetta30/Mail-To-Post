...
<body>
<a href="#edit-addressBook" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-addressBook" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: addressBookInstance, action: 'update']" method="PUT">
