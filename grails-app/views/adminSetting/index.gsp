        ...
        <div class="row">
            <div class="col-lg-4 col-md-5">
                <div class="card card-user">
                    <div class="image">
                        <asset:image src="user/background.jpg" alt="..."/>
                    </div>

                    <div class="content">
                        <div class="author">
                            <asset:image src="user/faces/face-2.jpg" class="avatar border-white" alt="..."/>
                        ...
                        <ul class="list-unstyled team-members">
                            <li>
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <asset:image src="user/faces/face-0.jpg" alt="Circle Image"
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <asset:image src="user/faces/face-1.jpg" alt="Circle Image"
                                                         class="img-circle img-no-padding img-responsive"/>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <asset:image src="user/faces/face-3.jpg" alt="Circle Image"
                                                         class="img-circle img-no-padding img-responsive"/>
                                        </div>
                                    </div>
