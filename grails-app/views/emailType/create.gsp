...
<body>
<a href="#create-emailType" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-emailType" class="content scaffold-create" role="main">
    ...
    <g:form url="[resource: emailTypeInstance, action: 'save']">
        <fieldset class="form">
