...
<body>
<a href="#create-letterPost" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-letterPost" class="content scaffold-create" role="main">
    ...
    <g:form url="[resource: letterPostInstance, action: 'save']">
        <fieldset class="form">
